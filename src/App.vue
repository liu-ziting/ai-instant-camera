<template>
    ...
    <div id="scalable-wrapper" ref="scalableWrapper">
        ...
        <div class="camera-case">
            ...
            <div class="lens-assembly">
                <div class="lens-ring-grip">
                    <div class="lens-glass-frame">
                        <video ref="videoRef" autoplay playsinline muted :class="{ 'rear-view': currentFacingMode === 'environment' }"></video>
            ...
            <div class="brand-label">PRO-CAM <span class="ai-label">AI</span></div>
        </div>
    </div>
